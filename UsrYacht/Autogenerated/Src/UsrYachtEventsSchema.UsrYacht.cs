	...
	public class UsrYachtEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("641a1920-3e84-b89b-24e5-ff056c514faa"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("5b3f9ac0-923a-4b26-a922-bfdae9d7e335"),
				CreatedInSchemaUId = new Guid("baf25c01-e1af-4ade-999f-ac505ebc38d3"),
				ModifiedInSchemaUId = new Guid("baf25c01-e1af-4ade-999f-ac505ebc38d3")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("baf25c01-e1af-4ade-999f-ac505ebc38d3"));
		}
